...
SAMPLES = [
    SampleDefinition("strawberry", "Strawberry Pop", "food", "Easy", 3, "cute strawberry sticker", ["#FF5B66", "#4BBB62", "#7A4A2C", "#FFF4E2", "#FF9AA1", "#E43A46"], build_strawberry),
    SampleDefinition("mushroom", "Mushroom Nest", "plants", "Easy", 4, "friendly forest mushroom", ["#FF725D", "#F3D5A7", "#C99860", "#FFFDF8", "#E14C45", "#A86F4A"], build_mushroom),
    SampleDefinition("whale", "Bubble Whale", "animals", "Easy", 4, "tiny blue whale", ["#6174FF", "#3040B7", "#FFFDF7", "#79E7F0", "#4FC3FF", "#1B2555"], build_whale),
    SampleDefinition("cactus", "Sunny Cactus", "plants", "Easy", 4, "potted cactus", ["#3DCB51", "#A6E945", "#1C8B2C", "#FFF8F0", "#9A663C", "#E7B54F"], build_cactus),
    SampleDefinition("fish", "Candy Fish", "animals", "Medium", 5, "small tropical fish", ["#FDB235", "#F06D74", "#7C5AF6", "#FFF5E0", "#53C6E8", "#1D2957"], build_fish),
    SampleDefinition("flower", "Bloom Burst", "plants", "Medium", 5, "cartoon flower", ["#FF88B8", "#F96198", "#FFD34D", "#59C95C", "#2C9D49", "#FFF7F1"], build_flower),
    SampleDefinition("cupcake", "Cupcake Glow", "food", "Medium", 5, "cute cupcake", ["#FF9EBC", "#F6C55D", "#E39D36", "#FF7043", "#67D56A", "#FFF4E8"], build_cupcake),
    SampleDefinition("pear", "Pear Picnic", "food", "Medium", 5, "juicy pear", ["#97D84C", "#C2ED59", "#6C4C31", "#2E8E37", "#FFF6EC", "#E9C866"], build_pear),
    SampleDefinition("turtle", "Turtle Tide", "animals", "Medium", 6, "gentle turtle", ["#4EBB6B", "#6FD877", "#59D4DD", "#2B8E56", "#FFF0B7", "#1E2A55"], build_turtle),
    SampleDefinition("snail", "Garden Snail", "animals", "Medium", 6, "cute snail", ["#E98F52", "#FFD9A8", "#A86D48", "#6ACF72", "#FFF6E8", "#202757"], build_snail),
]
...
def build_level_from_pixellab(args: argparse.Namespace) -> None:
    ...
    client = pixellab.PixelLabClient.from_env()
    response = client.generateImagePixflux({
        "description": args.prompt,
        "imageSize": {"width": args.board_size, "height": args.board_size},
    ...
    quantized = pil_image.convert("RGBA").quantize(colors=args.max_colors).convert("RGBA")
